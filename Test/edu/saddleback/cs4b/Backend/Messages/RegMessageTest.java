...
class RegMessageTest
{
    ...
    void testTypeForDisMsg()
    {
        ...
        RegMessage ms = new RegMessage("Test", "User", channels);
        assertEquals("Reg-Msg", ms.getType());
    }
    ...
    void testUserNameForDisMsg()
    {
        ...
        RegMessage ms = new RegMessage("Test", "User", channels);
        assertEquals("User", ms.getUserName());
    }
    ...
    void testChannelsForDisMsg()
    {
        ...
        RegMessage ms = new RegMessage("Test", "User", channels);
        assertEquals(channels, ms.getChannels());
    }
